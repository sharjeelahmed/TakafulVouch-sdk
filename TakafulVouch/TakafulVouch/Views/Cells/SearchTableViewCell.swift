...
class SearchTableViewCell: UITableViewCell {
    ...
    @IBOutlet weak var offer_desc: UILabel!
    @IBOutlet weak var offer_distance: UILabel!
    ...
    func configureCellWith(searchTerm:String, cellText:String)
    {
        ...
        do {
           ...
           // let highlightColour = UIColor(colorLiteralRed: 124/255.0, green: 215/255.0, blue: 204/255.0, alpha: 0.5)
			let highlightColour = UIColor.init(red: 124/255.0, green: 215/255.0, blue: 204/255, alpha: 0.5)
